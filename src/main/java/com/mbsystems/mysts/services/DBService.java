...
public void instantiateTestDatabase() throws ParseException {
	...
	Cliente cli1 = new Cliente(null,"Maria Silva","benatti1104@gmail.com","198569845625",TipoCliente.PESSOAFISICA, pe.encode("123"));
	cli1.getTelefones().addAll(Arrays.asList("268896565","15648492"));
	
	Cliente cli2 = new Cliente(null,"Ana Costa","murilopiloto33@gmail.com","62182165002",TipoCliente.PESSOAFISICA, pe.encode("123"));
	cli2.addPerfil(Perfil.ADMIN);
	cli2.getTelefones().addAll(Arrays.asList("268896544","4448492"));
	...
	Endereco e3 = new Endereco(null, "Floriano","2106", null, "Centro","3844959",cli1,c2);
